      ...
      case 'IcosahedronGeometry':
        if (currentcolor == 0xF66120) {
          if (planetViewed == 0) {
            ...
            info.innerHTML = " <span>FutureForceDAO</span>";

            description.innerHTML = "<br/>在这艘即将开往未来的太空飞船上，<br/>我们将会为大家领航，一起探索前行的航向";
          }
        ...
        if (currentcolor == 0x26D7E7) {
          if (planetViewed == 1 || planetViewed == 3 || planetViewed == 4) {
            planetViewed = 2;
            info.innerHTML = " <span id='couleur'>全网漫游指南</span>";

            document.getElementById('couleur').style.color = "#26d7e7";

            description.innerHTML = "<br/>精选各类有趣的工具、网站和服务，与你共同探索浩瀚的数字海洋";
        ...
        if (currentcolor == 0xffc12d) {
          if (planetViewed == 1 || planetViewed == 2 || planetViewed == 4) {
            planetViewed = 3;
            info.innerHTML = '<span id="couleur">人生管理指南</span>';


            description.innerHTML = "<br/>数字化工具成长社区的探索者";
        ...
        if (currentcolor == 0xacacac) {
          if (planetViewed == 1 || planetViewed == 2 || planetViewed == 3) {
            planetViewed = 4;
            info.innerHTML = '<span id="couleur">未来探索指南</span>';
            document.getElementById('couleur').style.color = "#acacac";

            description.innerHTML = "<br/>定义未来的同时，未来也在塑造我们";
